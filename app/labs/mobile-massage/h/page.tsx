...
const SERIF =
  "font-[family-name:var(--font-fraunces)] font-light [font-variation-settings:'SOFT'_60] tracking-[-0.012em]";
...
export default async function SoftWellnessVariant() {
  ...
  return (
    <>
      <main
        className={`${fraunces.variable} relative isolate overflow-x-clip bg-[linear-gradient(180deg,#f2f7f5_0%,#eef4f1_45%,#e6efeb_100%)] ${BODY} selection:bg-[#0d4f4f]/15 selection:text-[#0d4f4f]`}
      >
        ...
        <section className="mx-auto max-w-7xl px-5 pt-24 pb-16 sm:px-8 sm:pt-28 lg:pb-24">
          ...
          <div className="mt-9 grid gap-10 lg:mt-12 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:items-start lg:gap-16">
            <div className={rise("[animation-delay:140ms]")}>
              ...
              <h1
                className={`${SERIF} mt-4 max-w-[20ch] text-balance text-[clamp(2.25rem,3.9vw,3.6rem)] leading-[1.06] text-[#0d4f4f]`}
              >
                {heroHeading}
              </h1>
            ...
            >
              ...
              <p className="mt-4 flex items-baseline gap-2">
                <span
                  className={`${SERIF} text-[clamp(4rem,7vw,5.75rem)] leading-none text-[#0d4f4f]`}
                >
                  {price}
                </span>
                <span
                  className={`${SERIF} text-3xl leading-none text-[#0d4f4f]`}
                >
                  €
                </span>
              </p>
        ...
        <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:py-28">
          <div className="grid gap-12 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-20">
            <div>
              ...
              <h2
                className={`${SERIF} mt-4 max-w-[20ch] text-balance text-[clamp(2rem,3.6vw,3.1rem)] leading-[1.08] text-[#0d4f4f]`}
              >
                {priceHeading}
              </h2>
              <p className="mt-6 max-w-[58ch] text-lg leading-relaxed">
        ...
        <section className="mx-auto max-w-7xl px-5 pb-6 sm:px-8">
          <div className="border-y border-[#0d4f4f]/12 py-14 sm:py-20">
            <p
              className={`${SERIF} mx-auto max-w-[22ch] text-balance text-center text-[clamp(2rem,4.6vw,4rem)] leading-[1.08] text-[#0d4f4f]`}
            >
              {pullQuote.lead}{" "}
              <em className="italic text-[#2f4f4f]">{pullQuote.accent}</em>
            </p>
          </div>
        </section>
        ...
        >
          <div className="max-w-2xl">
            ...
            <h2
              className={`${SERIF} mt-4 text-balance text-[clamp(2rem,3.6vw,3.1rem)] leading-[1.08] text-[#0d4f4f]`}
            >
              {processHeading}
            </h2>
          ...
          <ol className="mt-14 grid gap-10 lg:grid-cols-4 lg:gap-8">
            {processSteps.map((step, i) => (
              <li key={step.title} className="relative pl-20 lg:pl-0">
                ...
                <span
                  className={`${SERIF} absolute top-0 left-0 flex h-12 w-12 items-center justify-center rounded-full bg-white text-xl text-[#0d4f4f] ring-1 ring-[#0d4f4f]/15 shadow-[0_10px_24px_-14px_rgba(13,79,79,0.5)] lg:relative`}
                  aria-hidden
                >
                  {i + 1}
                </span>
        ...
        <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:py-28">
          <div className="grid gap-14 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-center lg:gap-20">
            ...
            <div>
              ...
              <h2
                className={`${SERIF} mt-4 max-w-[22ch] text-balance text-[clamp(2rem,3.6vw,3.1rem)] leading-[1.08] text-[#0d4f4f]`}
              >
                {stageHeading}
              </h2>
              ...
              <div className="mt-12 rounded-[2rem] bg-white/50 p-7 ring-1 ring-white/70 sm:p-9">
                <h3
                  className={`${SERIF} text-[clamp(1.6rem,2.6vw,2.2rem)] leading-tight text-[#0d4f4f]`}
                >
                  {vipHeading}
                </h3>
        ...
        <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:py-28">
          ...
          <div className="mt-16 grid gap-10 border-t border-[#0d4f4f]/12 pt-14 lg:grid-cols-2 lg:gap-20">
            <div>
              ...
              <h2
                className={`${SERIF} mt-4 text-balance text-[clamp(1.8rem,3vw,2.6rem)] leading-[1.1] text-[#0d4f4f]`}
              >
                {areaHeading}
              </h2>
        ...
        <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:py-28">
          <div className="mx-auto max-w-3xl">
            <div className="text-center">
              ...
              <h2
                className={`${SERIF} mx-auto mt-4 max-w-[20ch] text-balance text-[clamp(2rem,3.6vw,3.1rem)] leading-[1.08] text-[#0d4f4f]`}
              >
                {faqHeading}
              </h2>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-[2rem] bg-[#0d4f4f] px-6 py-16 text-center text-white sm:px-12 sm:py-20 lg:py-24">
              ...
              <div className="relative mx-auto max-w-2xl">
                ...
                <h2
                  className={`${SERIF} mt-4 text-balance text-[clamp(2.2rem,4.2vw,3.6rem)] leading-[1.05] text-white`}
                >
                  {ctaHeading}
                </h2>
