...
/* ── Typografie ─────────────────────────────────────────────────────── */
/* Eine einzige Schrift: Geist aus dem Root-Layout – wie auf der Website.
   Die kinematische Wirkung kommt aus Gewicht, Enge und Größe, nicht aus
   einem zweiten Schriftschnitt. */
      ...
      <main>
          ...
          >
            <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end lg:gap-16">
              <div className="max-w-2xl">
                ...
                <h1
                  className={`${DISPLAY} mt-5 text-[clamp(2.3rem,5.1vw,4.15rem)] sm:mt-6 leading-[1.04] ${T_PRIMARY} ${RISE}`} style={rise(80)}
                >
            ...
            <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
              ...
              <div>
                ...
                <div className="mt-8 flex flex-wrap items-end gap-x-5 gap-y-2 border-y border-white/10 py-5">
                  <span
                    className={`${NUM} text-[2.7rem] leading-[0.85] text-[#f2a93b]`}
                  >
                    {price}
        ...
        <section className={`relative border-t border-white/10 bg-[#07302f]`}>
          <div className="relative aspect-[4/5] overflow-hidden sm:aspect-[4/3] lg:aspect-[21/9]">
            ...
            <div className={`${CONTAINER} absolute inset-0 flex flex-col justify-end pb-12 sm:pb-16 lg:justify-center lg:pb-0`}>
              <p
                className={`${DISPLAY} max-w-4xl text-balance text-[clamp(2.3rem,5.4vw,4.6rem)] leading-[1.02] ${T_PRIMARY}`}
              >
                {c.pullQuote.lead}{" "}
            ...
            <div className="pointer-events-none absolute inset-x-0 bottom-0 hidden xl:block">
              <div className={`${CONTAINER} flex justify-end pb-12`}>
                <div className="pointer-events-auto max-w-sm border-l border-[#f2a93b]/50 pl-6">
                  <h2 className={`${DISPLAY} text-balance text-2xl leading-tight ${T_PRIMARY}`}>
                    {c.stageHeading}
                  </h2>
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-col items-start">
                        <span
                          className={`${NUM} text-[2.4rem] leading-none text-[#f2a93b] sm:text-[3.4rem]`}
                        >
        ...
        >
          ...
          <div className={`${CONTAINER} relative text-center`}>
            ...
            <h2 className={`${DISPLAY} mx-auto mt-8 max-w-3xl text-balance text-[clamp(2.1rem,4.2vw,3.4rem)] leading-[1.06] ${T_PRIMARY}`}>
              {c.ctaHeading}
            </h2>
