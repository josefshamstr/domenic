 ...
 * Ein Longread in der Ich-Form: Lesespalten (Newsreader 19px/1.75) wechseln
 * sich mit vollflächigen Bildbändern ab. Geist bleibt für Labels und UI.
...
const BODY = `${SERIF} text-[19px] leading-[1.75] text-[#1d2b2b]`;
...
function H2({ children, light = false }: { children: ReactNode; light?: boolean }) {
  return (
    <h2
      className={`${SERIF} mt-7 text-balance text-[clamp(2rem,4.2vw,2.9rem)] leading-[1.12] tracking-[-0.01em] ${
    ...
    <figure className="relative isolate h-[72svh] min-h-[440px] max-h-[860px] w-full overflow-hidden bg-[#1d2b2b]">
      ...
      <figcaption className="absolute inset-x-0 bottom-0">
        <div className="mx-auto w-full max-w-3xl px-5 pb-10 sm:px-8 sm:pb-14">
          ...
          {heading && (
            <h2
              className={`${SERIF} mt-5 text-balance text-[clamp(1.9rem,3.8vw,3.1rem)] italic leading-[1.15] text-white`}
            >
              {heading}
            </h2>
          )}
          {quote && (
            <p
              className={`${SERIF} text-balance text-[clamp(1.6rem,3.4vw,2.7rem)] italic leading-[1.22] text-white`}
            >
              {quote}
            </p>
          )}
          {caption && (
            <p className="mt-4 max-w-xl font-sans text-sm leading-relaxed text-white/85">
              {caption}
            </p>
          )}
        </div>
...
export default async function StoryScrollPage() {
  ...
  return (
    <div
      className={`${newsreader.variable} bg-[#fbfaf7] text-[#1d2b2b] selection:bg-[#0d4f4f]/15`}
    >
      <main>
        ...
        <section className="pt-28 pb-20 sm:pt-36 sm:pb-28">
          <Column>
            ...
            <h1
              className={`${SERIF} mt-7 text-balance text-[clamp(2.6rem,5.6vw,4.75rem)] leading-[1.04] tracking-[-0.015em] text-[#1d2b2b] ${rise("[animation-delay:140ms]")}`}
            >
              {c.heroHeading}
            </h1>

            <p
              className={`${SERIF} mt-8 max-w-prose text-balance text-[1.3rem] leading-[1.6] text-[#1d2b2b] sm:text-[1.4rem] ${rise("[animation-delay:220ms]")}`}
            >
              {c.heroSubtitle}
            </p>

            <p className={`${BODY} mt-6 max-w-prose text-[#4b5856] ${rise("[animation-delay:280ms]")}`}>
              {c.priceDescription}
            </p>
            ...
            >
              <p className={`${SERIF} leading-none text-[#1d2b2b]`}>
                <span className="text-[4.5rem] tracking-[-0.02em] sm:text-[5rem]">
                  {price}
                </span>
                <span className="ml-1.5 align-top text-[2rem] text-[#0d4f4f]">€</span>
              </p>
        ...
        <section className="py-20 sm:py-28">
          <Column>
            ...
            <p className={`${BODY} mt-7 max-w-prose`}>
            ...
            <dl className="mt-4 max-w-prose divide-y divide-[#1d2b2b]/10 border-y border-[#1d2b2b]/10">
              {[...c.included, c.includedExtra].map((item) => (
                <div key={item.title} className="grid gap-1 py-5 sm:grid-cols-[14rem_1fr] sm:gap-6">
                  ...
                  <dd className={`${SERIF} text-[17px] leading-[1.6] text-[#4b5856]`}>
                    {item.description}
                  </dd>
                </div>
              ))}
            </dl>
            <p className={`${SERIF} mt-5 max-w-prose text-[16px] italic leading-[1.6] text-[#4b5856]`}>
              {c.priceNote}
            </p>
          </Column>
        </section>
        ...
        <section className="py-20 sm:py-28">
          <Column>
            ...
            <p className={`${BODY} mt-7 max-w-prose text-[#4b5856]`}>{c.processDescription}</p>

            <ol className="mt-12 max-w-prose">
              {c.processSteps.map((step, i) => (
                ...
                >
                  ...
                  <p className={`${BODY} mt-3`}>
                    <span
                      aria-hidden
                      className={`${SERIF} float-left mt-1 mr-4 text-[4.4rem] leading-[0.78] text-[#0d4f4f]`}
                    >
                      {i + 1}
                    </span>
                    {step.description}
        ...
        <section className="py-20 sm:py-28">
          <Column>
            <p className={`${BODY} max-w-prose`}>{c.stageText}</p>
            ...
            >
              ...
              <h3
                id="vip-heading"
                className={`${SERIF} mt-3 text-balance text-[clamp(1.6rem,3vw,2.1rem)] leading-[1.2] text-[#1d2b2b]`}
              >
                {c.vipHeading}
              </h3>
              <p className={`${SERIF} mt-4 max-w-prose text-[18px] leading-[1.7] text-[#1d2b2b]`}>
                {c.vipText}
              </p>
        ...
        <section className="py-20 sm:py-28">
          <Column>
            ...
            <p className={`${BODY} mt-7 max-w-prose`}>{c.forWhomDescription}</p>
            <ul className={`${SERIF} mt-5 flex max-w-prose flex-wrap items-baseline gap-x-2.5 gap-y-1 text-[19px] leading-[1.6] text-[#1d2b2b]`}>
            ...
            <h3 className={`${SERIF} mt-14 text-balance text-[clamp(1.6rem,3vw,2.1rem)] leading-[1.2] text-[#1d2b2b]`}>
              {c.areaHeading}
            </h3>
            <p className={`${BODY} mt-5 max-w-prose`}>{c.areaDescription}</p>
            <ul className="mt-5 flex max-w-prose flex-wrap gap-x-2.5 gap-y-1 font-sans text-[15px] leading-relaxed text-[#4b5856]">
            ...
            <p className={`${SERIF} mt-8 max-w-prose text-[17px] italic leading-[1.65] text-[#4b5856]`}>
        ...
        <section className="border-y border-[#1d2b2b]/10 bg-white py-20 sm:py-28">
          <Column>
            ...
            <H2>{c.faqHeading}</H2>
            <p className={`${BODY} mt-7 max-w-prose text-[#4b5856]`}>{c.faqIntro}</p>

            <div className="mt-10 divide-y divide-[#1d2b2b]/10 border-y border-[#1d2b2b]/10">
              {c.faqs.map((faq) => (
                <details key={faq._key} className="group">
                  <summary
                    className={`${SERIF} flex min-h-11 cursor-pointer list-none items-start justify-between gap-5 rounded-sm py-5 text-[1.25rem] leading-[1.35] text-[#1d2b2b] transition-colors hover:text-[#0d4f4f] [&::-webkit-details-marker]:hidden ${FOCUS}`}
                  >
                  ...
                  <p className={`${SERIF} max-w-prose pb-7 text-[17px] leading-[1.7] text-[#4b5856]`}>
                    {faq.answer}
                  </p>
                </details>
              ))}
        ...
        <section id="final-cta" className="bg-[#0d4f4f] py-20 text-white sm:py-28">
          <Column>
            ...
            <p className={`${SERIF} mt-7 max-w-prose text-[19px] leading-[1.75] text-white/85`}>
              {c.ctaText}
            </p>
        ...
        <section aria-label="Schlusszeile" className="py-24 sm:py-36">
          <div className="mx-auto w-full max-w-6xl px-5 sm:px-8">
            <p
              className={`${SERIF} text-balance text-[clamp(2.6rem,8.5vw,7.5rem)] leading-[0.98] tracking-[-0.025em] text-[#1d2b2b]`}
            >
