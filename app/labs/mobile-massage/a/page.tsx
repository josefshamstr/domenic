 ...
 * Warmer Off-White-Grund, Geist extrabold als Display-Schnitt, Gold nur als
 * Hairline, Kapitälchen-Label und ein einziger Akzent im Pull-Quote. Teal als
 * Text- und Button-Farbe. Ruhig, viel Luft, keine Verläufe, keine Schatten.
 */
...
export default async function VariantA() {
  ...
  return (
    <div className="bg-[#f6f2ec] text-[#1c1a17]">
      <main className="overflow-x-clip selection:bg-[#0d4f4f]/15">
          ...
          <div className="grid gap-16 lg:grid-cols-[minmax(0,1fr)_minmax(0,22rem)] lg:items-start lg:gap-20">
            <div>
              ...
              <div className="mb-9 flex items-center gap-5 lg:hidden">
                ...
                <div>
                  <span className="block text-xl font-bold tracking-tight text-[#0d4f4f]">
                    {c.name}
                  </span>
              ...
              <h1
                className="mt-6 text-balance text-[clamp(2.5rem,4.6vw,3.5rem)] font-extrabold leading-[1.06] tracking-[-0.03em] text-[#0d4f4f]"
              >
                {headingLead}
                {headingRest && (
                  <>
              ...
              <div className="mt-10">
                ...
                <div className="mt-5 flex flex-wrap items-end gap-x-6 gap-y-3">
                  <span
                    className="text-[3.5rem] font-extrabold leading-none tracking-[-0.03em] text-[#0d4f4f]"
                  >
            ...
            <div className="hidden lg:block">
              <Frame
                ...
                caption={
                  <>
                    <span className="block text-lg font-bold tracking-tight text-[#0d4f4f]">
                      {c.name}
                    </span>
        ...
        <section className="border-t border-[#b8893a]/40">
          <div className="mx-auto max-w-5xl px-5 py-28 sm:px-8 sm:py-36">
            <header className="max-w-2xl">
              ...
              <h2
                className="mt-6 text-balance text-[clamp(2rem,3.8vw,3rem)] font-extrabold leading-[1.1] tracking-[-0.025em] text-[#0d4f4f]"
              >
                {c.priceHeading}
              </h2>
            ...
            <div className="mt-16 grid gap-16 lg:grid-cols-[minmax(0,22rem)_minmax(0,1fr)] lg:gap-20">
              ...
              <div>
                <h3 className="text-[11px] font-semibold uppercase tracking-[0.24em] text-[#856022]">
                  Im Preis enthalten
                </h3>
                <ul className="mt-5 border-y border-[#b8893a]/40 divide-y divide-[#b8893a]/40">
                  {[...c.included, c.includedExtra].map((item, i) => (
                    ...
                    >
                      <span
                        className="text-[1.375rem] font-bold leading-none tracking-tight text-[#a67a2e] tabular-nums"
                        aria-hidden
                      >
        ...
        >
          <p
            className="mx-auto max-w-5xl px-5 text-balance text-center text-[clamp(2.5rem,7vw,5.5rem)] font-extrabold leading-[1.04] tracking-[-0.03em] text-[#0d4f4f] sm:px-8"
          >
            {c.pullQuote.lead}{" "}
            <em className="not-italic text-[#a67a2e]">{c.pullQuote.accent}</em>
          </p>
        </section>
            ...
            <div className="mt-16 grid gap-16 lg:grid-cols-[minmax(0,1fr)_minmax(0,20rem)] lg:gap-20">
              <ol className="grid gap-x-10 gap-y-12 sm:grid-cols-2">
                {c.processSteps.map((step, i) => (
                  ...
                  >
                    <span
                      className="block text-[1.75rem] font-bold leading-none tracking-tight text-[#a67a2e] tabular-nums"
                      aria-hidden
                    >
                      {String(i + 1).padStart(2, "0")}
                    </span>
          ...
          <div className="mx-auto max-w-5xl px-5 py-28 sm:px-8 sm:py-36">
            <div className="grid gap-16 lg:grid-cols-[minmax(0,22rem)_minmax(0,1fr)] lg:gap-20">
              ...
              <div>
                ...
                <h3
                  className="mt-6 text-balance text-[clamp(1.75rem,3vw,2.375rem)] font-extrabold leading-[1.15] tracking-[-0.02em] text-[#0d4f4f]"
                >
                  {c.vipHeading}
                </h3>
        ...
        <section id="final-cta" className="bg-[#0d4f4f] text-white">
          <div className="mx-auto max-w-5xl px-5 py-28 sm:px-8 sm:py-36">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <h2
                className="mt-7 text-balance text-[clamp(2.25rem,4.6vw,3.75rem)] font-extrabold leading-[1.08] tracking-[-0.03em]"
              >
                {c.ctaHeading}
              </h2>
              ...
              />
              <p className="mt-5 text-xl font-semibold tracking-tight text-white/90">
