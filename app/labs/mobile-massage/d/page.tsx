...
/** Running text: 18px/1.7 Geist, measure capped at ~66 characters. */
      ...
      <main className="bg-white text-[#111]">
        <div className="mx-auto w-full max-w-2xl px-5 sm:px-6">
          ...
          <section className="pt-32 pb-16 sm:pt-32 sm:pb-20">
            ...
            <h1 className="mt-6 text-balance text-4xl font-extrabold leading-[1.05] tracking-tight text-[#0d4f4f] sm:text-5xl">
              {headingText}
            </h1>
            ...
            <div className="mt-12 sm:mt-14">
              <p className="flex items-baseline gap-2 text-[#0d4f4f]">
                <span className="text-7xl font-extrabold leading-none tracking-tight lining-nums tabular-nums">
            ...
            <ul className="mt-4 divide-y divide-[#0d4f4f]/15 border-y border-[#0d4f4f]/15">
              {[...included, includedExtra].map((item) => (
                <li key={item.title} className="py-4">
                  <p className="text-lg font-bold leading-snug tracking-tight text-[#0d4f4f]">
                    {item.title}
                  </p>
            ...
            <ol className="mt-10 space-y-8">
              {processSteps.map((step, i) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="text-2xl font-extrabold leading-snug tracking-tight text-[#0d4f4f]">
                      {step.title}
                    </h3>
          ...
          <section className="py-16 sm:py-24">
            <p className="text-balance text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl lg:text-6xl">
              ...
              <span style={{ color: CORAL }}>{pullQuote.accent}</span>
            </p>
          </section>
          ...
          <section className="py-14 sm:py-20">
            ...
            <h3 className="mt-14 text-2xl font-extrabold leading-snug tracking-tight text-[#0d4f4f]">
              {areaHeading}
            </h3>
          ...
          <section className="py-14 sm:py-20">
            ...
            <div className="mt-10 border-b border-[#0d4f4f]/15">
              {faqs.map((faq) => (
                ...
                >
                  <summary
                    className={`flex min-h-14 cursor-pointer list-none items-center justify-between gap-6 py-4 text-xl font-bold leading-snug tracking-tight text-[#0d4f4f] marker:content-none [&::-webkit-details-marker]:hidden ${FOCUS} rounded-sm`}
                  >
          ...
          <section id="final-cta" className="py-16 sm:py-24">
            ...
            <p className="mt-14 text-lg leading-[1.7]">
              Herzlich,
              <br />
              <span className="text-2xl font-extrabold tracking-tight text-[#0d4f4f]">
                {name}
              </span>
            </p>
          </section>
